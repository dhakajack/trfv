...
After quizzing benjack-Carol about benjack-assassination when benjack-N3 is happening:
	say "[one of][quotation mark]As soon as you swat one, another pops up. First [bold type]JFK[roman type] -- I thought that set things right. But as soon as he was fixed, up steps [bold type]RFK[roman type] and everything drifts back towards the same futures. And don[apostrophe]t even get me started on [bold type]Martin Luther King[roman type].[quotation mark][or]Carol claims that the she orchestrated the assassinations of both Robert Kennedy and Martin Luther King with the assistance of the Deep Ones.[no line break][stopping][paragraph break]".
