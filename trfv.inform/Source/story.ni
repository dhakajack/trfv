...
After quizzing DAN8-Christabell about benjack-Vermont:
	say "Christabell replies, [quotation mark]There be not much to say on my Part, [bold type]Vermont[roman type], being far from where I spent my [bold type]youth[roman type]. [if DAN8-Christabell is candid]. In truth, I never set my Foote here all the Tymme I did live, but onely did come tardily some many years after my own [bold type]Deathe[roman type], and that not of my Volition[end if]. Thus, there is little I can add of local flavour beyond the explorations that you may set upon your own Selffe.[quotation mark]".
...
After quizzing DAN8-Christabell about benjack-Cragne:
	say "[quotation mark]I suppose you must know the Cragnes; they own all this property and that mansion on the far side of the hill,[quotation mark] you ask.[paragraph break][quotation mark]I have beheld many of the Crânes, hasting aloung the Pathes, dallying here and there, about their divers business.[quotation mark][paragraph break][quotation mark]What do you think of them?[quotation mark][paragraph break][quotation mark]To witte, nunne did have [bold type]Seight[roman type] of me, thow summe haf talked within my Presence.[if DAN8-Christabell is candid]  They are a most curious Family and I have seen various [bold type]marks[roman type]upon them, not all of them Wholesumme[end if].[quotation mark][paragraph break]".
