...
Understand "bed/mattress" as the benjack-bed when the player is in M2F3.
...
After quizzing benjack-Carol about benjack-babySubject when benjack-N3 is happening:
	say "[one of][quotation mark]Carol, we need to level. About that [bold type]mark[roman type] that you allegedly placed: [bold type]Christabell[roman type] says I[apostrophe]m not pregnant and that you are try to manipulate me.[quotation mark][paragraph break][quotation mark]Does she now?[quotation mark] Carol says with a sly smile. [quotation mark]Well, I suppose it[apostrophe]s just a matter of which of us you trust. How is it that I[apostrophe]m supposed to have manipulated you?[quotation mark][paragraph break][quotation mark]Well.[quotation mark] You think for a minute. [quotation mark]I thought it was some kind of a threat. Against me, or maybe against the baby.[quotation mark][paragraph break][quotation mark]That[apostrophe]s not how it works, [bold type]Christabell[roman type]. A [bold type]Mark[roman type] is a Warde of Protection. The only benefit I derive is being able to work magic through someone who is bemarked. The person themself is merely the medium and comes to no harm at all.[quotation mark][paragraph break][quotation mark]So, am I pregnant or not?[quotation mark][paragraph break][quotation mark]There[apostrophe]s nothing I can say that will convince you one way or another, Naomi, so why ask?[quotation mark][or]Carol sticks to her argument that you are indeed pregnant and that you baby bears her mark, but that she means no harm by it.[no line break][stopping][paragraph break]".
