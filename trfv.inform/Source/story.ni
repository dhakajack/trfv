...
The release number is 5. [submitted 20181207] 
...
benjack-colony is a subject.  Understand "colony/Massachusetts/colonies/colonie" as benjack-colony when the player is in DAN8. The printed name of benjack-colony is "The Massachusetts Colony".
...
benjack-PC is a subject. Understand "self/myself/me/Naomi/yourself" as benjack-PC when the location is in the benjack-realm. The printed name of benjack-PC is "me".

Rule for clarifying the parser's choice of benjack-PC: do nothing.

benjack-Cragne is a subject.  Understand "Crane/Crâne/Cranes/Crânes/Cragne/Cragnes" as benjack-Cragne when the location is in the benjack-realm. The printed name of benjack-Cragne is "the Cragnes".

benjack-death is a subject.  Understand "death/deathe/deaths/deathes" as benjack-death when the location is in the benjack-realm and benjack-R0 is not happening. The printed name of benjack-death is "death".
...
After quizzing benjack-Christabell about benjack-lineage:
	say "[one of][quotation mark]Surely, you suspect -- your Eyes, your Fayce, your Carriage -- all about you I have seen in the Looking-glass. We are of a common Stock, you and I, whence stems your [bold type]Spektral Seight[roman type].[quotation mark][paragraph break][quotation mark]Because we[apostrophe]re both [bold type]Cragnes?[roman type][quotation mark] you ask.[paragraph break][quotation mark]Nay, neither, I reckon. No [bold type]Crâne[roman type] Blood runs -- fynne, I allow, did run, for sayke of Correctness -- did run through my Veinnes. My surname is [apostrophe]Burt[apostrophe], in case that catches notice. And if I do not mistake, you have not the Aspect of Fruite fallen from the gnarled Tree of the [bold type]Crânes[roman type] -- although I did once wot by Providence wot Happenstance, know a [bold type]Crâne[roman type] also, a certain [bold type]Carol[roman type], of Our [bold type]Lineage[roman type].[quotation mark][paragraph break][quotation mark]Am I a [bold type]Cragne[roman type]? No. I married one. [bold type]Peter[roman type] is a [bold type]Cragne[roman type] -- I just married in. We had blood tests and everything. Our kids won[apostrophe]t have two heads. I[apostrophe]m sure he and I aren[apostrophe]t related.[quotation mark][paragraph break][quotation mark]Tell me of your Ancestors,[quotation mark] Cristabell asks.[paragraph break][quotation mark]Going back a generation on my father[apostrophe]s side, he and his dad were carpenters in Lithuania and came to the US in 30s. He had a little shop in Hull...[quotation mark] Cristabell waves you on impatiently; clearly, that part of your ancestry does not excite her. [quotation mark]But on my mom[apostrophe]s side -- my birth mom, that is, her family traces back to the UK. My cousin did a school report on our family tree, and I think we go back to the Bassetts on that side. Does that ring any bells?[quotation mark][paragraph break][quotation mark]Like a Papist Belfry on the Newe Year.[quotation mark][paragraph break][quotation mark]...[quotation mark][paragraph break]Christabell clarifies, [quotation mark]My owne Mother was but one Generation remouved from Family Bassett. A wealthey Family, they did dwell not far a-way.[quotation mark][or]It turns out you and Christabell are distantly related. Going back to colonial times, you both descended from the Bassett family on your mothers[apostrophe] sides.[no line break][stopping][paragraph break]".
...
Before going a direction (called the way) when benjack-R0 is happening and benjack-Christabell has been chatty and the location is DAN8:
	if the room the way from the location is nothing:
		continue the action;
	otherwise:
		say "[one of]Cristabell calls after you, [quotation mark]I do thank you for diverting summe Houres with mee in Discourse sweet. I do entreat you return upon your Convenience that we may again share some Werdes.[quotation mark][or][quotation mark]Do endeavour to mind yourself amongst the Crânes![quotation mark][paragraph break][quotation mark]I will. I always do.[quotation mark] You shout back, as you walk away.[no line break][or][quotation mark]I shall not keep you further from your most industrious Perambulations,[quotation mark] Christabell jests.[paragraph break][quotation mark]See you later,[quotation mark] you call back to her.[paragraph break][quotation mark]I do most fervently so desire![quotation mark][or][quotation mark]Go with the my Blessing, dear girl![quotation mark] Christabell says cheerfully as you depart.[paragraph break][quotation mark]May the Force be with you![quotation mark][paragraph break][quotation mark]Of what Forces do you speake, Friend?[quotation mark][paragraph break][quotation mark]Nevermind, it[apostrophe]s just how we say goodbye these days.[quotation mark][paragraph break][quotation mark]Truly the Werlde of the Future be a Marvel.[quotation mark][or]Christabell bids you well, as you depart.[no line break][stopping][paragraph break]".
...
Understand "comforter/blanket/duvet/cover/bedspread" as the benjack-comforter when the player is in M2F3.
Understand "light/pastel/blue/wool" as benjack-comforter when benjack-N2 is happening.
Understand "fluffy/pink/white/dotted/polka"  as benjack-comforter when benjack-N1 is happening.
Understand "thin/blue" as benjack-comforter when benjack-N3 is happening.
The N1-desc of the benjack-comforter is "A fluffy white comforter with tiny polka dots; snug and comfy even through a Vermont winter."

The benjack-bed is a benjack-shadow in M2F3.  The printed name of benjack-bed is "bed".
Understand "bed/mattress/headboard" as the benjack-bed when the player is in M2F3.
...
Understand "tea party" as the benjack-dolls when benjack-n1 is happening.
...
Instead of implicit-quizzing benjack-Carol about benjack-dolls or quizzing benjack-Carol about benjack-dolls:
	try quizzing benjack-Carol about benjack-CarolteaParty.
...
Understand "[benjack-snortlesToken]" as the benjack-elephant when the location is in the benjack-realm.
...
Understand "kitchen/plywood/oven/stove/icebox" or "play kitchen" or "ice box" as benjack-kitchen when the player is in M2F3.
...
Understand "pot/pan/pots/pans/lobster/steamer/sauce/frying" as benjack-pots when the player is in M2F3.
...
Understand "child-size/roll-top/colonial/writing" as benjack-desk when benjack-n1 is happening.
...
Understand "lamp/cord/shade/light" or "power cord" as benjack-lamp when the player is in M2F3.
...
Understand "record player" or "phonograph/turntable/speaker/speakers" as benjack-recordplayer when the player is in M2F3.
...
Understand "wagner/Walküre/Walkure/Valkyrie/Valkyries" or "Die Walküre" or "Die Walkure" as benjack-record when benjack-n2 is happening.

The benjack-table is a benjack-shadow.  The printed name of the benjack-table is "folding stand".
Understand "fold/stand/wooden" as benjack-table when the player is in M2F3.
...
Understand "frame/golden/ornate/heavy" or "photo frame" or "picture frame" as benjack-frame when the player is in M2F3.
...
Understand "beasts/beast/beetle/beetles/wing/wings/tail/tails" as benjack-beasts when the player is in M2F3.
...
Understand "photo/photograph/portrait/picture/man/balding/avuncular/dwight/eisenhower/president/ike/official" as benjack-Eisenhower when the player is in M2F3 and benjack-N1 is happening.
...
Understand "toy chair" or "toy chairs" or "tiny/chair/chairs" as benjack-toychair when the player is in M2F3.
...
Understand "wall/walls" as benjack-wall when the player is in M2F3.
...
Understand "scrapbook/book/spiral/spiral-bound" as the benjack-scrap-5 when the player is in M2F3 and benjack-N1 is happening.
The description of the benjack-scrap-5 is "[benjack-scrap-5-desc]".
Understand "newsprint/bits" or "little bits of newsprint" as benjack-scrap-5 when benjack-n1 is happening.
...
The benjack-slithering-vomit-bladder-of-Katallakh is an open container.  Understand "slithering/vomit/bladder/katallakh/slimy/dark-green/flesh/envelope/fleshy" or "slithering vomit bladder of Katallakh" or "vomit bladder of Katallakh" or "bladder of Katallakh" or "envelope of flesh" as the benjack-slithering-vomit-bladder-of-Katallakh. The printed name of the benjack-slithering-vomit-bladder-of-Katallakh is "slithering vomit bladder of Katallakh". The description of the slithering vomit bladder of Katallakh is "A  thick, rugated envelope of flesh. Occasionally, it slithers a bit.". The indefinite article of the benjack-slithering-vomit-bladder-of-Katallakh is "the".
		...
		if benjack-times_whined of benjack-N1 is:
			...
			-- otherwise:
				if the player carries something benjack-Katallakh-devourable (called the item):
					...
					say "[quotation mark]If you are going to be such a stick in the mud, [bold type]";
					if L is:
					-- benjack-monkey:
...
To say benjack-whine3:
	say "[quotation mark]Yes, [bold type]Misses Winkelbottom[roman type],[quotation mark] nods Carol, [quotation mark]I am sure [bold type]Naomi[roman type] knows that she just has to say [apostrophe][bold type]bottoms-up[roman type][apostrophe] to get the [bold type]tea party[roman type] started, but she[apostrophe]s playing her own game now I think, and it[apostrophe]s not fun![quotation mark][paragraph break]".
	
To say benjack-whine4:
	say "[quotation mark]Uh oh, Naomi,[quotation mark] say Carol with what you can tell is feigned concern, [quotation mark][bold type]Malice the Clown[roman type] says he[apostrophe]s getting upset that you are holding up the [bold type]tea party[roman type], and he wants to know why you haven[apostrophe]t said the magic words [apostrophe][bold type]bottoms-up[roman type][apostrophe]. He says he wonders if you really want to spend all of eternity in here, and I told him that no, probably you don[apostrophe]t, but he said maybe she does, and I said, well I guess we[apostrophe]ll find out, right?[quotation mark][paragraph break]".
...
When benjack-N1 ends:
	benjack-stage-off 1;
	now Benjack-clipping-shark is unseen;
	now Benjack-clipping-actress is unseen;
	now Benjack-clipping-body is unseen;	
	benjack-conversation-restore-defaults;
	now benjack-baby-door is in M2F3.
	
Chapter 7 - After N1

The description of the benjack-baby-door is "A sign on the door to the north says [benjack-baby-door-desc]". 
...
benjack-KHSpell is a subject.  Understand "kwisatz/haderach" as benjack-KHSpell when the location is DAN8 and benjack-R0 is not happening and yourself is benjack-spell_enabled. The printed name of benjack-KHSpell is "kwisatz haderach spell".
...
After informing benjack-Christabell about benjack-fading when benjack-R1 is happening:
	say "[one of][quotation mark]Christabell, I think your [bold type]fading[roman type] is getting worse -- every time I pass by you seem a little less radiant, a bit more transparent.[quotation mark][paragraph break]Christabell makes an effort and becomes more solid for a moment. [quotation mark]Truly, there be no mistaking that, after summe many Centuries, it is the Waye of [bold type]Spirits[roman type] to gently fade from Perception. As [bold type]Potence[roman type] wayneth, so our [bold type]Louminance[roman type]  does diminish [apostrophe]til even those with the [bold type]Seight[roman type] do not aperceeve. To compound the Matter, with each Generation, the [bold type]Seight[roman type] does itself dilute, it being in the Blood.[quotation mark][or]You tell Christabell that she seems to be fading from sight, growing more and more transparent and dim. At this rate, you don[apostrophe]t know how much longer you[apostrophe]ll be able to see her.[no line break][stopping][paragraph break]".
...
After quizzing benjack-Christabell about benjack-Fusion:
	say "[one of][quotation mark]The [bold type]Fusion[roman type] bindeth a Spirit to a Place, just as my unhappy [bold type]Demise[roman type] did bind me in Perpetuity to this [bold type]Ironne[roman type],[quotation mark] Christabell says, gesturing to the railroad track. [quotation mark]Onely threw a princely summe of [bold type]Potence[roman type] keenly wielded can the [bold type]Fusion[roman type] be broken and a Spirit set a-free.[quotation mark][or]Christabell uses the term [quotation mark]fusion[quotation mark] to mean that which binds a spirit to the physical world.[no line break][stopping][paragraph break]".
...
After quizzing benjack-Christabell about benjack-InvisibleWorld:
	say "[quotation mark]By that I do mean the incorporeal world of [bold type]Spirits[roman type] and other such [bold type]Beings[roman type] perceived onely by the Seight.[quotation mark][paragraph break]".
...
After quizzing benjack-Christabell about benjack-Hugo when benjack-R1 is happening:
	say  "[one of][quotation mark][bold type]Carol[roman type] did not oftentimes speake of her [bold type]Father[roman type], but I do know, much to the belike of the [bold type]Deep Ones[roman type], I doubt me not, that a man of the Sea was he -- not in the sense of a Saylor, but drawn to the Deep by Intelleckt and Inclineation, being more a Shipswrighte or one who does put his Designe upon Paper that others might put Hammer to Nayle in its Construcion.[quotation mark][paragraph break]Christabelll laughs, [quotation mark]At one Poynt, [bold type]Carol[roman type] did inform me, he did sit bodily upon my very Pyle of [bold type]Ironne[roman type], but perceived me not for lack of the Seight. In that Moment he did hatch an Idea to sell the [bold type]Ironne[roman type] for the making of Ships to bring War to his Enemies, for he was bloodthirsty and did detest those not spaking Engelish, putting me much in Mynd of Ewen Breeves, a [bold type]Preacher[roman type] I did once have the Misfortune to know.[quotation mark][or]Christabell says that Carol[apostrophe]s father Hugo once tried to sell the railroad tracks to the navy as scrap [bold type]iron[roman type].[no line break][stopping][paragraph break]".
...
After quizzing or informing benjack-Christabell about benjack-ChristabellTeaParty:
...
After quizzing or informing benjack-Christabell about benjack-Mirror:
	say "[one of]After you tell Christabell about being trapped in Carol[apostrophe]s room by the mirror that appeared out of nowhere, Christabell offers some reassurance: [quotation mark]Fret you not, I know of the [bold type]Seeming[roman type] she did Werke, and it is but a weake one and cannot be used against your Minde again.[quotation mark][or]The trick that Carol used to trap you in her room won[apostrophe]t work on you a second time.[no line break][stopping][paragraph break]".
	
After quizzing or informing benjack-Christabell about benjack-Seeming:
	say "[one of]After you tell Christabell about being trapped in Carol[apostrophe]s room by mirror that appeared out of nowhere, Christabell offers some reassurance: [quotation mark]Fret you not, I know of the [bold type]Seeming[roman type] she did Werke, and it is but a weake one and cannot be used against your Minde again.[quotation mark][or]The trick that Carol used to trap you in her room won[apostrophe]t work on you a second time.[no line break][or][quotation mark]A [bold type]Seeming[roman type] is naught moor than a brief Illusion; it is easily washed from the Minde and with diligent Practice can be ignored without Effort.[quotation mark][stopping][paragraph break]".
...
The N2-desc of benjack-record is "The center is black, with silver writing. You can[apostrophe]t make out much beyond [quotation mark]Wagner[quotation mark] and [quotation mark]Die Walküre[quotation mark]."
...
Understand "empty/patch/blank/spot/discolored/space/discoloured/portrait/president/eisenhower/picture/photo/photograph/official/frame" as benjack-patch when the player is in M2F3.
...
Understand "drawing/drawings/art/artwork" as benjack-drawings when the player is in M2F3.
...
Understand "top/crayon/upper/crayon/splotch/splotches/tubular/bubbles" or "crayon drawing" or "tubular thing" as benjack-crayon when the player is in M2F3.
...
Understand "watercolor/watercolors/watercolours/watercolour/painting/bottom/lower" as benjack-watercolor when the player is in M2F3.
...
The benjack-makeupMirror is a benjack-shadow.  The printed name of the benjack-makeupMirror is "makeup mirror".
Understand "mirror" or "makeup mirror" as benjack-makeupMirror when the player is in M2F3.
...
Understand "stacked/books/book/spine/spines/hadcover/textbook/textbooks" as benjack-stackedBooks when the player is in M2F3.
Understand "our colonial heritage" or "fundamentals of algebra" or "modern etiquette" or "our/colonial/heritage/fundamentals/algebra/math/textbook/modern/etiquette/primer/hardcover" as benjack-stackedBooks when the player is in M2F3 and benjack-N2 is happening.
The N2-desc of benjack-stackedBooks is "Several hardcover books are stacked on one side of the desk and topped by a stapled bit of looseleaf paper. Reading along the spines from top to bottom, the books are: [quotation mark][italic type]Our Colonial Heritage[roman type][quotation mark], [quotation mark][italic type]Fundamentals of Algebra[roman type][quotation mark], and [quotation mark][italic type]Modern Etiquette: A Primer[roman type][quotation mark].".
...
Understand "desk chair" or "chair/wooden/high-backed" as benjack-deskChair when the player is in M2F3.
...
benjack-LBJ is a subject.  Understand "lyndon/baynes/bloated/johnson/president" or "president johnson" as benjack-LBJ when the location is M2F3. The printed name of benjack-LBJ  is "President Lyndon Johnson".
...
benjack-scrapbookSubject is a subject.  Understand "scrapbook" or "scrap book" as benjack-scrapbookSubject when the location is in the benjack-realm and benjack-r1 has ended. The printed name of benjack-scrapbookSubjec is "scrapbook".
...
After quizzing benjack-Carol about benjack-America when benjack-N2 is happening:
	say "[one of][quotation mark][bold type]Father[roman type] says that [bold type]America[roman type][apostrophe]s place in the world is on top, and that[apostrophe]s part of [bold type]Mattanit[roman type][apostrophe]s [bold type]Third Covenant[roman type], that we assume our rightful place as the Seat of the [bold type]Elder Gods[roman type] and bring all other nations to worship them.[quotation mark][paragraph break][quotation mark]He does?[quotation mark] you ask, trying to humor her.[paragraph break][quotation mark]But there is a lot wrong with [bold type]America[roman type] right now because people don[apostrophe]t follow tradition: drugs, music, people who don[apostrophe]t understand how some people are meant to be above other people, and that some people are meant to be their servants. That sort of thing. Don[apostrophe]t worry, though, [bold type]father[roman type][apostrophe]s plan will fix it all.[quotation mark][or][quotation mark][bold type]Father[roman type] says that [bold type]America[roman type][apostrophe]s place in the world is on top, and that[apostrophe]s part of [bold type]Mattanit[roman type][apostrophe]s [bold type]Third Covenant[roman type], that we assume our rightful place as the Seat of the [bold type]Elder Gods[roman type] and bring all other nations to worship them.[quotation mark][stopping][paragraph break]".
...
After quizzing benjack-Carol about benjack-CarolFather when benjack-N2 is happening:
	say "[one of][quotation mark][bold type]Father[roman type] has a brilliant plan and everyday he works to make it happen.[quotation mark][paragraph break][quotation mark]Does that pay well?[quotation mark] you ask.[paragraph break][quotation mark]Well, it[apostrophe]s not his day job, of course.[quotation mark] Apparently, Carol does not recognize sarcasm. [quotation mark]He works in Connecticut in the Electric Boats Division of General Dynamics. That[apostrophe]s a company that makes [bold type]submarines[roman type]. He used to be an engineer, but now he[apostrophe]s a supervisor, so he tells other people what to do.[quotation mark][or][quotation mark]As I said, he has a plan to bring back the [bold type]Elder Gods[roman type]. When he[apostrophe]s not doing that, he works at a company that manufactures [bold type]submarines[roman type].[quotation mark][stopping][paragraph break]".
	
After quizzing benjack-Carol about benjack-CarolMother when benjack-N2 is happening:
	say "[one of][quotation mark]She is a proper wife and serves [bold type]father[roman type] as he desires; she is entirely committed to [bold type]father[roman type][apostrophe]s plan. For her, that means mostly hosting cocktail parties and luncheons, and sometimes being on wives[apostrophe] committees and the like. [bold type]Father[roman type] says that he has made a lot of important deals because she is such a good entertainer and knows what men like.[quotation mark][paragraph break][quotation mark]Also,[quotation mark] Carol adds, [quotation mark]she makes a mean cucumber sandwich.[quotation mark][or][quotation mark]She is a proper wife, and serves [bold type]father[roman type] as he desires; she is entirely committed to [bold type]father[roman type][apostrophe]s plan.[quotation mark][stopping][paragraph break]".

After quizzing benjack-Carol about benjack-subjectNixon when benjack-N2 is happening:
	say "[quotation mark][bold type]Nixon[roman type] is a linchpin in [bold type]father[roman type][apostrophe]s plan. He should have won against [bold type]Kennedy[roman type] in 1960, but I wasn[apostrophe]t strong enough then to make it happen.[quotation mark][paragraph break]".
	
After quizzing benjack-Carol about benjack-subjectKennedy when benjack-N2 is happening:
	say "[one of][quotation mark][bold type]Father[roman type] says that [bold type]Kennedy[roman type] would have ruined [bold type]America[roman type] and destroyed his plan, and that even though I did my best[quotation mark] -- here she glances at the press clipping on the desk -- [quotation mark]it will take years to undo the damage that he did in his first three years in office: filling the heads of drug-addled youth with crazy ideas, letting the Blacks think they might have a voice, and weakening the institutions and traditions that kept [bold type]America[roman type] in the hands of her rightful masters.[quotation mark][or][quotation mark][bold type]Father[roman type] says that [bold type]Kennedy[roman type] would have ruined [bold type]America[roman type] and destroyed his plan, and that even though I did my best, it will take years to undo the damage that he did in his first three years in office.[quotation mark][stopping][paragraph break]".
	
After quizzing benjack-Carol about benjack-submarine when benjack-N2 is happening:
	say "[one of][quotation mark]My [bold type]father[roman type] chose his profession specifically to advance our rapport with the Old Ones. For instance, [bold type]Kennedy[roman type] is a strong node in history; to put [bold type]father[roman type][apostrophe]s plan back on track, we had to give them one of the subs, the [bold type]Thresher[roman type], a few months back.[quotation mark][paragraph break][quotation mark]That[apostrophe]s horrible![quotation mark][paragraph break][quotation mark]No, just another Rune. I still have to stick it in the [bold type]scrapbook[roman type], but I[apostrophe]m afraid I left it at [bold type]school[roman type] in Farmington.[quotation mark][or]My [bold type]father[roman type] chose his profession specifically to advance our rapport with the [bold type]Elder Gods[roman type].[no line break][stopping][paragraph break]".
...
After quizzing benjack-Carol about benjack-newsprint when benjack-N2 is happening:
	say "[quotation mark]Some parts of history have to change for [bold type]father[roman type][apostrophe]s plan to take root. A submarine was a small price to pay.[quotation mark][paragraph break]".
...
Every turn when benjack-n2 is happening and benjack-carol is not n2-conversed:
	if a random chance of 1 in 3 succeeds:
		say "Carol [one of]continues to comb her long hair[or]carefully applies some makeup[or]mutters to herself in some forgotten language[or]does her nails[or]applies some rouge[or]doesn't seem aware of your skulking about her room[or]appears oblivious to your prescence[in random order]."
		
Every turn when benjack-Carol is requesting_permission:
	if a random chance of 1 in 4 succeeds:
		say "[one of]Carol reminds you that she'd really appreciate it if you would say [quotation mark]yes[quotation mark] so she could get on with the rest of her day.[or][quotation mark]Malice, is it me, or is Naomi being just a little bit selfish by now allowing me to place my mark?[quotation mark][paragraph break]Carol nods at Malice as he (apparently, though you don't hear a thing) lends her his wisdom.[paragraph break][quotation mark]No doubt about that at all,[quotation mark] giggles Carol with a conspiratorial wink at the demonic clown. [quotation mark]If she would just say [quotation mark]yes[quotation mark], the world [italic type]would[roman type] be a better place. From a certain point of view.[quotation mark][line break][or]Carol rolls her eyes waiting for you to say [quotation mark]yes[quotation mark] so she can place her mark.[or][quotation mark]Naomi, what are you afraid of? There really is nothing to it. A simple [quotation mark]yes[quotation mark] from you and we can go back to enjoying the wonderful autumn scenery.[quotation mark][line break][or]Carols head jerks suddenly towards the dolls. [quotation mark]No, Mister Sweetpaws, we cannot try out your suggestion, however expedient it would be, but thank you for caring.[quotation mark][paragraph break]She turns to you. [quotation mark]Young Master Sweetpaws says that he would like to help you say [quotation mark]yes[quotation mark], but I don't think that is quite the way this should work.[quotation mark][paragraph break][quotation mark]You do realize that we'll be here all day if you don't give your consent, don't you Naomi?[quotation mark] asks Carol.[or]Carol wipes some of the pus from around Mister Snortles eyes.[paragraph break][quotation mark]I know, Mister Snortles, I do wish she would say [quotation mark]yes[quotation mark] so we could get this marking business over with. There are so many things that need doing today.[quotation mark][line break][or][quotation mark]This marking business is getting tedious, isn't it, dear Naomi?[quotation mark] asks Carol.[or][quotation mark]I don't suppose there is anywhere you would rather be just now, is there?[quotation mark] Carol asks, with a glance out the window.[or]Carol again encourages you to allow her to place her mark by saying [quotation mark]yes[quotation mark] to give your consent.[or][quotation mark]Fine,[quotation mark] says Carol, looking at you with disappointment. I'm not going to nag you to death about this mark issue, but also realize that you will not make it out of this room alive until you say [apostrophe]yes[apostrophe] -- of your own free will of course. I wouldn't want to appear coercive.[quotation mark][line break][or]Despite what she said earlier, Carol continues to nag you about giving your consent for her to place her mark upon you.[or]Carol nags you to allow her to place her mark upon you.[stopping]".
...
Before hailing or conversing or speaking when benjack-R2 is happening for the first time:
	say "[quotation mark]My Greetings again, Naomi. Were you able to lifte the Burden of [bold type]Carol[roman type][apostrophe]s Runes and set a-free her Spirit?[quotation mark][paragraph break][quotation mark]No, not so much,[quotation mark] you admit. [quotation mark]She didn[apostrophe]t have the scrapbook with her. In fact, the whole thing didn[apostrophe]t go that well. She[apostrophe]s has some [bold type]resentment[roman type] towards you, and her dad[apostrophe]s plan sounds bonkers.[quotation mark][paragraph break][quotation mark]I have something very important to ask you, Christabell. [bold type]Carol[roman type] touched me…[quotation mark] You take a moment to compose yourself, [quotation mark][bold type]Carol[roman type] touched me here, and said she had marked my [bold type]baby[roman type], a daughter.[quotation mark][paragraph break]Christabell looks askew. [quotation mark]Oh?[quotation mark] She holds her hand palm out. [quotation mark]No. There be no [bold type]Baby[roman type]. Nor even so much as Thowt of one in your Entrayls. Not this Daye. She doth Laie most Cravenly to seeke Inflewance o[apostrophe]er you. I had hoped to save her, but History does itself repete -- for the Sayke of All, we must see to her Disruption.[quotation mark][paragraph break]";
 	continue the action.

Section 1 - R2 Subjects

benjack-Disruption is a subject.  Understand "disruption/disrupt/destroy/destruction" as benjack-Disruption when the location is in the benjack-realm. The printed name of benjack-Disruption is "disruption".

benjack-WindowSubject is a subject.  Understand "window/windowe/blockayde/blockade/windows/windowes/blockades/blockaydes" as benjack-windowSubject when the location is in the benjack-realm and benjack-n2 has ended. The printed name of benjack-windowSubject is "window".

Does the player mean implicit-informing the benjack-window: it is unlikely.

benjack-resentment is a subject.  Understand "resentment/resentments" as benjack-resentment when the location is DAN8 and benjack-R2 is happening. The printed name of benjack-resentment is "resentment".
...
benjack-clippingSubject is a subject.  Understand "assassination/assassinations/newsprint/newspaper"  or "news paper"as benjack-clippingSubject when the location is in the benjack-realm and benjack-r2 is happening. The printed name of benjack-clippingSubject is "assassination".

benjack-planSubject is a subject.  Understand "time/temporal/nodal/node/nodes/historical/plan/plans/history/timeline" or "time line" as benjack-planSubject when the location is in the benjack-realm. The printed name of benjack-planSubject is "plans".
...
After quizzing benjack-Christabell about benjack-resentment:
	say "[one of][quotation mark]Aye, there be some Truth in what she does say. Blossoming in her young Womanhood as she was, my Weale sorry tried by Tymme, I did luste after her with Desires carnal.[quotation mark][paragraph break][quotation mark]How is that even a thing? You first of all being dead and second not having a body?[quotation mark][paragraph break][quotation mark]These are fine faire Questions, dear Naomi, and I would entreate you explore them further with me hence -- and in great Detaile -- if your Appetites so leaneth, but this is the Howr to talk not of Love but Action. No alternative do I see but to see to [bold type]Carol[roman type][apostrophe]s [bold type]Disruption[roman type].[quotation mark][or]Christabell admits to lusting after Carol when the girl was a teenager, but now urges you to disrupt her.[no line break][stopping][paragraph break]".
	
After informing benjack-Christabell about benjack-resentment:
	say "[one of][quotation mark][bold type]Carol[roman type] seemed quite angry at you, Christabell.[quotation mark][paragraph break][quotation mark]I do suppose she does have summe Reason, but know you that she did lead me on and I do think appreciate my Attentions. I am given to wonder if it was not she who did lead mee about wrongly.[quotation mark][paragraph break][quotation mark]That[apostrophe]s no excuse.[quotation mark][or]Christabell brushes aside you mentions of how she might have wronged Carol.[no line break][stopping][paragraph break]".
	
After quizzing benjack-Christabell about benjack-Carolsubject when benjack-R2 is happening:
	say "[one of][quotation mark][bold type]Carol[roman type] was led falsely by her [bold type]Father[roman type] who did twist the Werdes of Mattanit and harness her rapport with the [bold type]Deep Ones[roman type]. He did conspire to remove the Constraints that have for Tymme endless held at Baye the [bold type]Elder Gods[roman type], what with the Misperception most grievous that gracious of their Libertie, they would Accorde him Dominion oe[apostrophe]r the Worlde.[quotation mark][paragraph break][quotation mark]And you don[apostrophe]t think that[apostrophe]s how that would go down?[quotation mark][paragraph break][quotation mark]Down would it go, most surely, but in no desirable Direction for him, for their Fury pent would burne All, before even a Werde he could say to ask his Rewarde (thow I opine it be served wel in that Manner).[quotation mark][or]According to Christabell, Carol[apostrophe]s father has been pursuing a plan to use Carol and her relationship to the Deep Ones to free the Elder Gods from their Eternal Sleep.[no line break][stopping][paragraph break]".
	
After informing benjack-Christabell about benjack-Carolsubject when benjack-R2 is happening:
	say "[one of][quotation mark]Christabell, I think that [bold type]Carol[roman type] is a danger -- maybe to the world itself. I don[apostrophe]t know how much of it is real or she[apostrophe]s just crazy. Or maybe I am. After all, I[apostrophe]m discussing with the Salem witch ghost whether the little girl ghost that thinks she[apostrophe]s responsible for the Kennedy [bold type]assassination[roman type] is insane. Maybe I need to be the one on the couch. That would explain a lot about the way today[apostrophe]s gone.[quotation mark][paragraph break][quotation mark]Perhaps short Slumber would be helpful, yes, but I do assure you, [bold type]Carol[roman type] be every bit so vitall a Danger as you do perceeve. It were e[apostrophe]er so when she did live, as she did grow in Power with Ayge, there came a Tymme where I, even loving her so, did bring her to End herself.[quotation mark][paragraph break][quotation mark]You are the reason she committed suicide?[quotation mark][paragraph break][quotation mark]And she does to this Daye count it sorely against mee.[quotation mark][or]You reiterate that Carol is a danger.[no line break][stopping][paragraph break]".
	
After quizzing benjack-Christabell about benjack-ElderGods when benjack-R2 is happening:
	say "[one of][quotation mark]There be few Things we did not speake of, even those of us bonded in the Longhouse -- first amongst them, the [bold type]Elder Gods[roman type], who be so alien to ouwr Minde, that nary a Glimpse of the Shadoe would rupture the Knotte of Reason. Ancient they are; ancient and cataclysmic and mad.[quotation mark][paragraph break][quotation mark]So, they[apostrophe]re evil?[quotation mark][paragraph break][quotation mark]Nay, for I do not believe they do have the Concept itself, that being Artefice of Man[apostrophe]s Minde. No, [bold type]Destruction[roman type] they provoketh onely by theyr unwitting, horrid Indifference. Ouwr Existence is not even Perceiv[apostrophe]d by them, I doubt me not.[quotation mark][or]Carol describes them as beings so alien that they are not even aware we exist or that their mere presence threatens our existence.[no line break][stopping][paragraph break]".
...
After informing benjack-Christabell about benjack-Hugo when benjack-R2 is happening:
	say "[one of][quotation mark][bold type]Carol[roman type][apostrophe]s [bold type]father[roman type], [bold type]Hugo[roman type], seems to have his own agenda -- [bold type]Carol[roman type] said he had a [bold type]plan[roman type], and it sounds like it revolved around manipulating politics. I[apostrophe]m not quite sure how everything plugs together, but he[apostrophe]s been intentionally shaping nodal points in history with [bold type]Carol[roman type][apostrophe]s help.[quotation mark][paragraph break][quotation mark]That be not an impossible Task for One so endowed with both her magickal Aptitudes and sharpness of Witte. She could with the Aide of the [bold type]Deep Ones[roman type] bring to pass an Event, or though their Interventions divert the Unfolding so the said Event never did occur.[quotation mark][or]Carol's father seems to have a plan to use the Deep Ones to liberate the Elder Gods from their slumber by manipulating historic turning points.[no line break][stopping][paragraph break]".

After informing benjack-Christabell about benjack-DeepOnes when benjack-R2 is happening:
	say "[one of][quotation mark]Whatever [bold type]Carol[roman type] and her [bold type]father[roman type] are up to, the [bold type]Deep Ones[roman type] are doing the dirty work.[quotation mark][paragraph break][quotation mark]Nay, they do reshape the Worlde by more subtle Means that you can comprehend and so are Agency, but the Runes are written in [bold type]Carol[roman type][apostrophe]s book; she is Author.[quotation mark][paragraph break][quotation mark]That sounds semantic. She couldn[apostrophe]t do it without the [bold type]Deep Ones[roman type].[quotation mark][paragraph break][quotation mark]No Occasion do I have to make Argumente against you, as I wish that our Conversation remain amicable, but to my Poynte I do must needs sticke.[quotation mark][or]You go over how the Deep Ones seem to be directed by Carol and her father.[no line break][stopping][paragraph break]".
	
After informing benjack-Christabell about benjack-drawingSubject when benjack-R2 is happening:
	say "[one of][quotation mark]I saw a number of really creepy [bold type]drawings[roman type] in [bold type]Carol[roman type][apostrophe]s room -- she[apostrophe]s profoundly weird.[quotation mark][paragraph break][quotation mark]To the Weirdness of Minde, aye. But being her Instructress in the fyne Artes from her earliest Ayge, I do take some Pride in the Faithfulness of her Renderings.[quotation mark][or]You describe to Christabell the strange drawings in Carol[apostrophe]s room.[no line break][stopping][paragraph break]".
	
After informing benjack-Christabell about benjack-scrapbookSubject when benjack-R2 is happening:
	say "[one of][quotation mark][bold type]Carol[roman type] said she had left her [bold type]scrapbook[roman type] at her school -- I wonder if that[apostrophe]s true or if she was hiding them from me.[quotation mark][paragraph break][quotation mark]So distracted was she as a Gyrll, it is not unthinkable that she did simply leave it. You must watch for another Oppourtunity to present itself.[quotation mark][or]You mention that Carol[apostrophe]s scrapbook wasn[apostrophe]t in her room when you paid your last visit, so you had no opportunity to destroy it using the [quotation mark]kwisatz haderach[quotation mark] spell.[no line break][stopping][paragraph break]".
	
After informing benjack-Christabell about benjack-clippingSubject when benjack-R2 is happening:
	say "[one of][quotation mark]On her desk, I saw a clipping of the [bold type]assassination[roman type] of President Kennedy -- we have Presidents now, like President Dukakis -- they are in charge of the whole government. Let me back up, the American government is divided into the principal branches: executive, legislative, and judicial. The president…[quotation mark][paragraph break][quotation mark]I do know what a President be; [bold type]Carol[roman type] had explained it to me upon a Tymme in much the excruciating Detaile as upon whych I did feare you do embark.[quotation mark][paragraph break][quotation mark]Fine. So, she had this [bold type]newspaper[roman type]…[quotation mark][paragraph break][quotation mark]Yes, I do know what be a News Paper.[quotation mark][paragraph break][quotation mark]Right. So, she had this [bold type]newspaper[roman type] article about the [bold type]assassination[roman type] of President Kennedy -- is that one of her Runes?[quotation mark][paragraph break][quotation mark]Nay, that be the result of her calling upon the [bold type]Deep Ones[roman type]; the Rune that doth have Relation to it would of its own Accord enter into her Book.[quotation mark][or]You tell Christabell about the newspaper clipping about the JFK assassination that Carol had on her desk and your suspicion that Carol was behind it, likely with the help of the Deep Ones.[no line break][stopping][paragraph break]".
	
After informing benjack-Christabell about benjack-planSubject when benjack-R2 is happening:
	say "[one of][quotation mark]From what I was able to piece together, [bold type]Carol[roman type][apostrophe]s [bold type]father[roman type] has been using [bold type]Carol[roman type] and her connection to the [bold type]Deep Ones[roman type] to influence key points of history. It sounds like their end-game is to bring back the [bold type]Elder Gods[roman type].[quotation mark][paragraph break][quotation mark]That surpriseth mee not and might do explain the circular Nature of her Unfolding, if in altering History she does send her Spirit back upon itself.[quotation mark][or]You posit that Carol is intentionally affecting nodal points in history to alter the future and restore the reign of the Elder Gods.[no line break][stopping][paragraph break]".
...
After quizzing benjack-Christabell about benjack-Disruption when benjack-R2 is happening:
	say "[one of]Christabell asks, [quotation mark]How old of Yeares was [bold type]Carol[roman type] when you did see her?[quotation mark][paragraph break][quotation mark]About fourteen, maybe fifteen, I[apostrophe]d guess.[quotation mark][paragraph break][quotation mark]I see.[quotation mark] Christabell says self-consciously. [quotation mark]Yes, at that Ayge her Weale outstrove her Wisedom. Already had she devised a [bold type]Blockayde[roman type] against my Powers despite my [bold type]Mark[roman type] upon her.[quotation mark][paragraph break][quotation mark]Then there[apostrophe]s nothing we can do rein her in?[quotation mark][paragraph break][quotation mark]I did not that say, quite,[quotation mark] replies Christabell. [quotation mark]If you open the [bold type]Windowe[roman type] where she doth dwell, the [bold type]Blockayde[roman type] will be breached, and I can work a [bold type]Disruption[roman type] spell.[quotation mark][paragraph break][quotation mark]And what would become of [bold type]Carol[roman type]?[quotation mark][paragraph break][quotation mark]Nothing. Not a thing. And that be a better Fate than hers now.[quotation mark][or]Christabell reiterates the plan to make sure you have it down pat, [quotation mark]Get you to [bold type]Carol[roman type][apostrophe]s Bedchamber, and there cause her to be distracted, by such Diversions as you may, and so avoiding her constant Attentions, slyly do heave open the [bold type]Windowe[roman type] that I may werke my Magicks past her Wardes.[quotation mark][paragraph break][quotation mark]Right, got it,[quotation mark] you acknowledge.[no line break][stopping][paragraph break]";
	now yourself is not benjack-ploughver-inhibited.
	
To say benjack-mark-glued:
	say "You are held in place by Christabell[apostrophe]s mark.[paragraph break][quotation mark]Sorry I am, Naomi,[quotation mark] she says, [quotation mark]but e[apostrophe]er you depart, I must tell you how to disrupt [bold type]Carol[roman type], after that, our Fate does reside in your two Hands.[quotation mark][paragraph break]".
...
Understand "motto/crest/shield/skull/coat-of-arms/heraldry/heraldic/familial" as benjack-sweater when the player is in M2F3 and benjack-n3 is happening.
...
Understand "shrunken/head" as benjack-clown when the player is in M2F3 and benjack-n3 is happening.
The N3-desc of benjack-desk is "Curved, tubular polished steel tubes support a single sheet of glass, about a half inch thick. A matching chair is right next to the desk. [if benjack-scrap-19 is in m2f3]Only a couple items sit atop the glass surface: a computer terminal and a binder[otherwise]The only item on the desk is a huge antiquated computer terminal[end if].".
...
The N3-desc of benjack-stackedBooks is "A few books are stacked next to the bed, but you can read the titles, [italic type]How to Make Friends and Influence People[roman type], [italic type]The Compleat Manual of Wardes and Seales[roman type], and [italic type]The Indian grammar begun: or, An essay to bring the Indian language into rules, for the help of such as desire to learn the same, for the furtherance of the Gospel among them[roman type].".
...
Understand "computer/terminal/datapoint/dumb/vt100/vt52/sticker" as benjack-terminal when the player is in M2F3.
...
Understand "art/sculptures/piece/artwork/artworks" or "pieces of art" or "pieces of artwork" as benjack-art when the player is in M2F3.
...
Understand "opalescent/egg/left/leftmost/megalokyniklosaurus/vernalis/bunny/rabbit/easter/dinosaur/raptor/velociraptor/killer" as benjack-egg when the player is in M2F3.
...
To say benjack-egg7:
	say "The air around you stirs with unfulfilled probabilities: a lab-coated woman trapped under a desk beats back a zombie with a crowbar, an owl spritzes a squeaky door with WD-40, a disheveled man in a paper bathrobe rides a toy bicycle through Chicago, a Methusaleh lifts his arms in prayer to a volcano god, a squirrel in samurai armor runs through a restaurant, a pointy-eared technician makes adjustments to the very fabric of reality... ".
...
Understand "right/conspicuous/absence/space/empty/emptiness/void" or "conspicuous absence of space" or "the conspicuous absence of space" as benjack-ambiguity when the player is in M2F3.
...
Understand "reel to reel recorder" or "reel to reel" or "nekton/reel/tape/tapes/tapedeck/recorder/magnetic/reel-to-reel" as benjack-tapedeck when the player is in M2F3.
...
Understand "scrapbook/notebook/printout/binder" or "print out" or "print outs" as benjack-scrap-19 when the player is in M2F3.
...
After quizzing benjack-Carol about benjack-nsc:
	say "[quotation mark]The [bold type]national security council[roman type] is part of the U.S. government: it is an advisory body to the Whitehouse on matters of national security. Currently, it is headed by Henry KIssinger, a confidante of President Nixon.[quotation mark][paragraph break]"

After quizzing benjack-Carol about benjack-ardf:
	say "[quotation mark]Yeah, I had to look that one up too. It means radio direction finding -- figuring out where a signal is coming from.[quotation mark][paragraph break]".

After quizzing benjack-Carol about benjack-Nixon when benjack-N3 is happening:
	say "[one of][quotation mark]He stands for everything I believe in: integrity, tradition, and the natural destiny of [bold type]America[roman type] to lead the world into the coming millennium. That[apostrophe]s why I decided to work on his campaign rather than take my acceptance to Middlebury.[quotation mark][or]Carol tells you she is his biggest fan. He can do no wrong by her.[no line break][stopping][paragraph break]".
	
After quizzing benjack-Carol about benjack-america when benjack-N3 is happening:
	say "[one of][quotation mark]After seeing everything going on in [bold type]America[roman type] this past year: the long-haired free love freaks, drugs, the degenerate culture of rock-and-roll, people too self-entitled to defend their country from the Gooks in [bold type]Vietnam[roman type], Blacks riding busses and voting -- all of it, I just couldn[apostrophe]t sit on the sidelines. I wanted to do [italic type]more[roman type] than just bring about the Ascendance of the [bold type]Elder Gods[roman type]. That[apostrophe]s going to take time, and I know that I only live another few months before my [bold type]suicide[roman type], so I decided to join the [bold type]Nixon[roman type] campaign and make a difference.[quotation mark][or][quotation mark]It[apostrophe]s going to hell in a handbasket,[quotation mark] replies Carol, [quotation mark]and not in a good way.[quotation mark] [stopping][paragraph break]".
	
After informing benjack-Carol about benjack-america when benjack-N3 is happening:
	say "[one of][quotation mark]Carol, I am from the future, I assure you that this plan of yours fails. The idea that the country could be ruled by a bigoted, narcissistic miscreant like you is unthinkable.[quotation mark][paragraph break]Carol smiles smugly.[no line break][or]You try to convince Carol that her plan does not succeed in the future, but her confidence is not shaken in the least.[no line break][stopping][paragraph break]".	
	
After informing benjack-Carol about benjack-intel when benjack-N3 is happening:
	say "[quotation mark]I[apostrophe]m not sure how this all figure into it, but in my day, in the 90s, most of the [bold type]computers[roman type] that we use have Intel chips in them. I have long suspected a diabolical cause.[quotation mark][paragraph break]".
	
After informing benjack-Carol about benjack-intel when benjack-N3 is happening:
	say "[quotation mark]I’m not sure how, but the company’s founding seems to have just as much influence on the future as all the [bold type]assassinations[roman type].[quotation mark][paragraph break]".
	
After quizzing benjack-Carol about benjack-vietnam when benjack-N3 is happening:
	say "[one of][quotation mark]The timing was wrong for [bold type]Nixon[roman type], so I sent [bold type]Sweetpaws[roman type] to throw a -- sorry -- monkeywrench into the peace talks to make sure they failed prior to the [apostrophe]68 election.[quotation mark][paragraph break]Carol looks over at the shelfs above her desk. [quotation mark]What[apostrophe]s that Master [bold type]Sweetpaws[roman type]? Oh yes, the geopolitical ramifications would indeed have been thorny.[quotation mark][or]Carol explains how Master Sweetpaws craftily manipulated global interests to ensure that the 1968 peace talks to end the war in Vietnam collapsed, undermining President Lyndon B. Johnson[apostrophe]s re-election campaign and advancing her man, Nixon.[no line break][stopping][paragraph break]".
...
After quizzing benjack-Carol about benjack-assassination when benjack-N3 is happening:
	say "[one of][quotation mark]As soon as you swat one, another pops up. First [bold type]JFK[roman type] -- I thought that set things right. But as soon as he was fixed, up steps [bold type]RFK[roman type] and everything drifts back towards the same futures. And don[apostrophe]t even get me started on [bold type]Martin Luther King[roman type].[quotation mark][or]Carol claims that she orchestrated the assassinations of both Robert Kennedy and Martin Luther King with the assistance of the Deep Ones.[no line break][stopping][paragraph break]".
	
After quizzing benjack-Carol about benjack-college when benjack-N3 is happening:
	say "[one of][quotation mark]I was accepted to Middlebury last term; turns out I have some aptitude for languages. I was going to major in linguistics with a minor maybe in history, but the more I looked at the school, the more I realized how unhappy I would be there. Do you know that they are actually trying to promote enrollment of everyone but Whites?  I decided to volunteer for the [bold type]Nixon[roman type] campaign instead.[quotation mark][or][quotation mark]I decided not to go there and decided to volunteer for the [bold type]Nixon[roman type] campaign instead,[quotation mark] replies Carol.[no line break][stopping][paragraph break]".
	
After quizzing benjack-Carol about benjack-suicide when benjack-N3 is happening:
	say "[one of][quotation mark]As I[apostrophe]ve matured, I[apostrophe]ve gained some insight into what is happening, both in my life and in this unfolding. I remember all your visits now, for instance, clearly. And with the aid of the [bold type]Elder Gods[roman type], I[apostrophe]m even beginning to be able to see around the corners and branches of things that haven[apostrophe]t happened yet -- some will, some won[apostrophe]t. That part is hard to sort out, of course.[quotation mark][paragraph break][quotation mark]My [bold type]suicide[roman type], however is unavoidable. If it hadn[apostrophe]t happened a few months from now, we wouldn[apostrophe]t have been talking now and in the past.[quotation mark][paragraph break][quotation mark]I can see what [bold type]Christabell[roman type] did to me then, but can[apostrophe]t change it. She was jealous of my power and future place with the [bold type]Elder Gods[roman type], but even more so, she felt spurned because I chose my [bold type]boyfriend[roman type] over her.[quotation mark][or]Carol says Christabell is responsible for driving her to suicide before the end of 1969. Carol suspects that Cristabell was jealous that she had a boyfriend.[no line break][stopping][paragraph break]".

After quizzing benjack-Carol about benjack-boyfriend when benjack-N3 is happening:
	say "[one of][quotation mark]In retrospect, he[apostrophe]s a bastard. If I could tell the myself that when I was my age -- with the 20-20 hindsight of temporal paradox, of course -- I would have walked away from him regardless of the what the [bold type]Elder Gods[roman type] saw in him.[quotation mark][paragraph break][quotation mark]But at the time, I couldn[apostrophe]t see that. He had just graduated from Wharton and entered into the family real estate business in New York City. There was no question that he would go places, especially with the inchoate horrors of primordial chaos pulling for him as they were.[quotation mark][or]Carol recognizes that her boyfriend back in 1969 was a clod, but it[apostrophe]s likely that Christabell pushed her to suicide because of jealousy over Carol[apostrophe]s relationship with him.[no line break][stopping][paragraph break]".
	
After quizzing benjack-Carol about benjack-carolFather when benjack-N3 is happening:
	say "[one of][quotation mark]I don[apostrophe]t like to brag,[quotation mark] Carol brags, [quotation mark]but [bold type]father[roman type] has done quite well for himself, not only is he Senior Executive Vice-President in charge of the Electric Boat Division of [bold type]General Dynamics[roman type] Dynamics, but he is now an advisor on President [bold type]Nixon[roman type][apostrophe]s National Security Council.[quotation mark][or]Carol says her father has worked his way onto President Nixon[apostrophe]s National Security Council, where he is privy to the even the most secret machinations of the American government.[no line break][stopping][paragraph break]".
...
After quizzing benjack-Carol about benjack-submarine when benjack-N3 is happening:
	say "[one of][quotation mark]Oh, I don[apostrophe]t know all that much about them. [bold type]Father[roman type] knows all the technical stuff. I just help coordinate what we do with the [bold type]Deep Ones[roman type].[quotation mark][or]Carol admits she isn[apostrophe]t up on the technical aspects of [bold type]submarines[roman type], but they do play a role in her business with the Deep Ones.[no line break][stopping][paragraph break]".
	
After quizzing benjack-Carol about benjack-carolMother when benjack-N3 is happening:
	say "[one of][quotation mark]Oh, mother expired some time ago, actually. [bold type]father[roman type] says that her hostess skills were helpful earlier in his career, but she really had nothing to offer these last few years and was getting to be something of a drag.[quotation mark][or]Apparently, Carol[apostrophe]s mother died some time ago; the cause isn[apostrophe]t really clear and Carol doesn[apostrophe]t seem disposed to elaborate.[no line break][stopping][paragraph break]".
	
After quizzing benjack-Carol about benjack-terminal when benjack-N3 is happening:
	say "[one of][quotation mark]I told [bold type]father[roman type] that sometimes I felt left out, so he had it set up for me. It helps me keep abreast of what[apostrophe]s going on here and there.[quotation mark][or]Carol seems to be plugged in to a high-level government information feed. The technology is astounding considering the era. There must be a mainframe somewhere within the mansion.[no line break][stopping][paragraph break]".
...
After quizzing benjack-Carol about benjack-moon when benjack-N3 is happening:
	say "[one of][quotation mark]That need not concern you. Soon the last traces of the usurping gods will be swept away and the [bold type]Elder Gods[roman type] restored to their glory.[quotation mark][or]Carol evades your question.[no line break][stopping][paragraph break]".
...
After quizzing benjack-Carol about benjack-zond3 when benjack-N3 is happening:
	say "[one of][quotation mark]It was a Soviet probe that photographed the far-side of the [bold type]moon[roman type] at high resolution and saw some things… that needed to be dealt with.[quotation mark][or][quotation mark]It was a Soviet probe that photographed the far-side of the moon.[quotation mark][stopping][paragraph break]".
	
After quizzing benjack-Carol about benjack-lem when benjack-N3 is happening:
	say "[one of][quotation mark]When Apollo astronauts land on the [bold type]moon[roman type], the part of the rocket that lands on the [bold type]moon[roman type] is the LEM or lunar escape module. When it[apostrophe]s time for them to leave, the upper part of the LEM called the lunar ascent module separates and flies up to dock with the lunar command module in lunar orbit.[quotation mark][or][quotation mark]All part of the moonshot.[quotation mark][stopping][paragraph break]".
	
After quizzing benjack-Carol about benjack-nekton when benjack-N3 is happening:
	say "[quotation mark]The Navy[apostrophe]s ill-considered attempt to deal with the [bold type]Deep Ones[roman type] without consulting me or my [bold type]father[roman type].[quotation mark][paragraph break]".
	
After quizzing benjack-Carol about benjack-glyphs when benjack-N3 is happening:
	say "[quotation mark]I have mastered only a few of the symbols of the language of the [bold type]Elder Gods[roman type] -- the ones that can be drawn without going insane.[quotation mark][paragraph break]".
...
After quizzing benjack-Carol about benjack-lostSubs when benjack-N3 is happening:
	say "[quotation mark]When we ask the [bold type]Deep Ones[roman type] for help, there is always a price.[quotation mark][paragraph break]".
...
After quizzing benjack-Carol about benjack-medcar when benjack-N3 is happening:
	say "[quotation mark]A network of sonic transducers that line the Mediterranean basin and can generate sounds to fool enemy [bold type]submarines[roman type].[quotation mark][paragraph break]".

After quizzing benjack-Carol about benjack-sosus when benjack-N3 is happening:
	say "[quotation mark]Strings of underwater sensors that help the military track [bold type]submarines[roman type].[quotation mark][paragraph break]".
...
After quizzing benjack-Carol about benjack-tile when benjack-N3 is happening:
	say "[one of][quotation mark]It[apostrophe]s not quite as real as the other pieces of [bold type]art[roman type] in my collection, because of course it does not exist yet.[quotation mark][or][quotation mark]It[apostrophe]s a thermal [bold type]tile[roman type] from the space plane Columbia some years from now.[quotation mark][stopping][paragraph break]".
...
After quizzing benjack-Carol about benjack-PloughverSpell when benjack-N3 is happening:
	say "[one of][quotation mark]You realize that every time you use that spell, you[apostrophe]re complicit in what you experience, right?[quotation mark][paragraph break][quotation mark]No, [bold type]Christabell[roman type] didn[apostrophe]t mention anything about that,[quotation mark] you plead, alarmed.[paragraph break][quotation mark]No, I wouldn[apostrophe]t suppose she would. It[apostrophe]s funny how she only tells parts of things, isn[apostrophe]t it?[quotation mark][or]Carol explains that the person casting the teleport spell shares in the responsibility for collateral damage that it causes.[no line break][stopping][paragraph break]".
	
After quizzing benjack-Carol about benjack-babySubject when benjack-N3 is happening:
	say "[one of][quotation mark]Carol, we need to level. About that [bold type]mark[roman type] that you allegedly placed: [bold type]Christabell[roman type] says I[apostrophe]m not [bold type]pregnant[roman type] and that you are try to manipulate me.[quotation mark][paragraph break][quotation mark]Does she now?[quotation mark] Carol says with a sly smile. [quotation mark]Well, I suppose it[apostrophe]s just a matter of which of us you trust. How is it that I[apostrophe]m supposed to have manipulated you?[quotation mark][paragraph break][quotation mark]Well.[quotation mark] You think for a minute. [quotation mark]I thought it was some kind of a threat. Against me, or maybe against the [bold type]baby[roman type].[quotation mark][paragraph break][quotation mark]That[apostrophe]s not how it works, [bold type]Christabell[roman type]. A [bold type]Mark[roman type] is a Warde of Protection. The only benefit I derive is being able to work magic through someone who is bemarked. The person themself is merely the medium and comes to no harm at all.[quotation mark][paragraph break][quotation mark]So, am I [bold type]pregnant[roman type] or not?[quotation mark][paragraph break][quotation mark]There[apostrophe]s nothing I can say that will convince you one way or another, Naomi, so why ask?[quotation mark][or]Carol sticks to her argument that you are indeed pregnant and that you baby bears her mark, but that she means no harm by it.[no line break][stopping][paragraph break]".
...
Instead of attacking someone (called spiritus):
	say printed name of spiritus;
	say " is unaffected -- the blow never lands."
